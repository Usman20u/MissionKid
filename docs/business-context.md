# MissionKid Business Context

## The problem

Families often struggle to turn screen-time limits into a positive next step. Simply ending device use can create conflict, while parents may not have a ready supply of short, age-appropriate activities. Children need a clear and appealing transition from passive viewing to something they can do in the real world.

## Target users

MissionKid serves families globally with children aged 4–10:

- Parents and caregivers who want a simple way to guide screen-time transitions.
- Children who can choose and complete a short activity with appropriate adult oversight.
...
Parents may face decision fatigue, repeated negotiation, and difficulty suggesting an activity that fits a child's age or the moment. Children may experience an abrupt stop with no attractive alternative. Existing screen-based entertainment can also reward longer use instead of helping the family leave the screen.
...
## Why screen time should lead to real-life action

MissionKid treats the screen as a bridge, not a destination. Each interaction should quickly result in an offline activity that supports participation, practical contribution, curiosity, creativity, movement, or rest. The product succeeds when the child spends less time in the experience and more time completing the chosen mission in real life.

## Global positioning

MissionKid is a global family product and is not tailored to Austria or any other single country. Missions should use culturally neutral, inclusive language and avoid assumptions about household structure, climate, location, resources, or purchasing power.

The repository, specifications, code, and commit messages use English. The MVP user interface supports English, German, and Russian, with English as the default. Localization should preserve meaning and safety rather than depend on literal translation.

## Product ergonomics

The interface must help families understand and act, not merely look attractive. Parent-facing interfaces should feel calm, trustworthy, clear, and control-oriented. Child-facing mission interfaces should feel simple, playful, encouraging, age-appropriate, not overstimulating, and not manipulative.
...
- The timer is a simple mission aid, not a monitoring, enforcement, or device-blocking tool.
- Reward Cards are encouraging acknowledgements, not money, payments, or promises of a reward. Any real-life reward is optional, parent-controlled, and parent-approved.
